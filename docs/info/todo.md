...
- [ ] NFS branch review follow-ups
    ...
    - **Helm chart pinning — decision (2026-08-18): keep the status quo** (exact pins + Renovate; no `Chart.lock`, no vendoring). Lifted to [AD-0008](../reference/architecture/decision_records.md#ad-0008-helm-chart-pinning-strategy) — see it for full rationale and accepted residual risk. Future code reviews should not re-flag missing `Chart.lock` files.
